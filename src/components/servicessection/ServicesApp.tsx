  ...
  return (
    <div className="relative flex max-w-4xl flex-col items-center py-24">
      ...
      <div className="flex max-w-xl flex-col text-center">
        <h2 className="font-medium leading-7 text-secondary">Services</h2>
        <h1 className="text-4xl font-medium tracking-tight">Go-To-Market Packs</h1>
        <Spacer y={4} />
        <h2 className="text-large text-default-500">
          Discover the GTM package that works for your organization.
        </h2>
      </div>
      <Spacer y={8} />
      <Tabs
      ...
      <div className="flex py-2">
        <p className="text-default-400">
          Are you an underserved community member?&nbsp;
          <Link color="foreground" href="https://calendly.com/malcolm-decuire" underline="always">
            Reserve Services
          </Link>
        </p>
      </div>
